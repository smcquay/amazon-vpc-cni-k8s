...
// func (c *IPAMD) setupServer() *http.Server {
...
// func eniV1RequestHandler(ipam *IPAMD) func(http.ResponseWriter, *http.Request) {
// 	return func(w http.ResponseWriter, r *http.Request) {
...
// func podV1RequestHandler(ipam *IPAMD) func(http.ResponseWriter, *http.Request) {
// 	return func(w http.ResponseWriter, r *http.Request) {
